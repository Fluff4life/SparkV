const manager = new ShardingManager("./bot.js", {
    ...
    execArgv: [
        ...process.argv,
        ...[
            Config.Debug.Enabled ? null : "--trace-warnings"
        ]
    ]
})
...
manager.on("shardCreate", (Shard) => {
    ...
    Shard.on("ready", () => {
        console.log(require("chalk").blue(`DEPLOY SUCCESS - SHARD ${Shard.id}/${manager.totalShards} DEPLOYED SUCCESSFULLY`))
    })
    ...
    Shard.on("disconnect", (event) => {
        ...
        console.log(require("chalk").red(`SHARD DISCONNECTED - SHARD ${Shard.id}/${manager.totalShards} DISCONNECTED. ${event}`))
    })
    ...
    Shard.on("death", (event) => {
        ...
        console.log(require("chalk").red(`SHARD CLOSED - SHARD ${Shard.id}/${manager.totalShards} UNEXPECTEDLY CLOSED!\nPID: ${event.pid}\nExit Code: ${event.exitCode}.`))
