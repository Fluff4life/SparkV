...
exports.run = async (bot, message, args, command, data) => {
  ...
  bot.distube.setVolume(message, parseInt(args[0])).then(() => message.reply(`${bot.config.bot.Emojis.music} | I set the volume to ${args[0]}!`)).catch(err => message.reply(`${bot.config.bot.Emojis.error} | Uh oh! An error occured.`))
},
