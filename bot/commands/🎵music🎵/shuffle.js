...
exports.run = async (bot, message, args, command, data) => {
  ...
  bot.distube.shuffle(message).then(() => message.reply(`${bot.config.bot.Emojis.music} | Okay, I'll shuffle the queue.`)).catch((err) => message.reply(`${bot.config.bot.Emojis.error} | Uh oh! An error occured.`))
},
