...
(exports.run = async (bot, message, args, command, data) => {
    ...
    const CreateSelection = async (bot, message, Category) => {
        ...
        if (Category === "👑Owner👑") {
            ...
            Selections.push({
                label: Category,
                description:
                    "Make your server more fun with our large ammount of games!",
                value: Category,
                emoji: "🎲",
            });
            ...
            Selections.push({
                label: Category,
                description:
                    "Play music right from your Discord server. With no ads and at no added cost!",
                value: Category,
                emoji: "🎵",
            });
            ...
            Selections.push({
                label: Category,
                description:
                    "Make your server x2 the fun with our image commands!",
                value: Category,
                emoji: "📷",
            });
            ...
            Selections.push({
                label: Category,
                description:
                    "Admins in your server only. You can make giveaways for your server to interact with!",
                value: Category,
                emoji: "🤵",
            });
            ...
            Selections.push({
                label: Category,
                description:
                    "Utility commands. Not very good unless you find a calculator fun.",
                value: Category,
                emoji: "🧰",
            });
            ...
            Selections.push({
                label: Category,
                description:
                    "Make your server way more fun with our fun commands!",
                value: Category,
                emoji: "😃",
            });
            ...
            Selections.push({
                label: Category,
                description:
                    "Commands for server moderators. Packed with everything one could need!",
                value: Category,
                emoji: "🛠️",
            });
        } else {
    ...
    if (!args.length) {
        const NewEmbed = new MessageEmbed()
            ...
            .setDescription(
                "Select a category from tapping the selection box below."
            )
            .setAuthor(
                "Ch1llBlox Help",
        ...
        if (!command) {
            return message.reply(
                `${bot.config.bot.Emojis.error} | That command doesn't exist or no longer exists!`
            );
        }
        ...
        const CommandHelpEmbed = new MessageEmbed()
            ...
            .addField(
                `**COOLDOWN**`,
                `\`\`\`${command.config.cooldown || 3} second(s)\`\`\``,
                true
            )
            .setFooter(
