...
exports.run = async (Bot, message, Arguments) => {
  ...
  if (!queue){
    return message.lineReplyNoMention("There is nothing in the queue right now! Try playing some songs.")
  }

  if (queue.pause){
    Bot.distube.resume(message)

    return message.lineReplyNoMention("I resumed the paused song for you!")
  }
