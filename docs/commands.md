...
| **bed**            | AAAAAAAAAAAAAAAAAAAAAAAAAAAH!   | {optional user}      | 2 seconds |
...
| **rainbow**        | wow you gae                     | {optional user}      | 2 seconds |
| **rip**            | RIP                             | {optional user}      | 2 seconds |
| **shit**           | Ewwwwww!                        | {user | self}        | 2 seconds |
| **slap**           | SLAP SLAP SLAP!                 | {user | self}        | 2 seconds |
| **trash**          | Ug trash.                       | {user | self}        | 2 seconds |
